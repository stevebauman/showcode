<template>
    <div
        class="relative flex flex-col items-center justify-between mb-4 overflow-hidden rounded-xl bg-ui-gray-600"
    >
        <div class="flex items-center justify-center w-full h-full bg-ui-gray-800">
            <button
                ...
                :key="index"
                :class="{
                    'text-ui-gray-50 bg-ui-gray-600 bg-opacity-60': active === tab,
                    'text-ui-gray-500 bg-ui-gray-700 bg-opacity-60 hover:bg-ui-gray-600 hover:text-ui-gray-400':
                        active !== tab,
                }"
