<template>
    <TModal
        ...
        :classes="{
            ...
            close: 'bg-gray-800 text-gray-600 rounded-full absolute right-0 top-0 -m-3 h-8 w-8 transition duration-100 ease-in-out hover:bg-gray-900 focus:ring-2 focus:ring-violet-500 focus:outline-none focus:ring-opacity-50',
