<template>
    <TModal
        ...
        :classes="{
            ...
            modal: 'bg-ui-gray-700 shadow rounded-xl w-full',
            body: 'p-8',
            header: 'border-b border-ui-gray-100 p-3 rounded-t',
            footer: 'bg-ui-gray-100 p-3 rounded-b',
            close: 'bg-ui-gray-800 rounded-full absolute shadow right-0 top-0 -m-3 h-8 w-8 transition duration-100 ease-in-out hover:bg-ui-gray-900 focus:ring-2 focus:ring-ui-focus focus:outline-none',
