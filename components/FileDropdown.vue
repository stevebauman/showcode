    ...
    >
        <div slot-scope="{ hide }" class="py-1 shadow-lg">
            <a
                ...
                class="block px-4 py-2 text-sm leading-5 text-ui-gray-100 transition duration-150 ease-in-out hover:bg-ui-gray-900 focus:outline-none focus:bg-ui-gray-900"
            >
                {{ option.title }}
            </a>
        </div>
