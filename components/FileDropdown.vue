<template>
    <TDropdown
        v-bind="$attrs"
        :classes="{
            button: 'block px-4 py-2 text-sm font-semibold text-white rounded-r-lg transition duration-100 ease-in-out bg-ui-violet-500 hover:bg-ui-violet-600 focus:border-ui-violet-500 focus:ring-2 focus:bg-ui-violet-600 focus:ring-ui-focus focus:outline-none disabled:opacity-50 disabled:cursor-not-allowed',
